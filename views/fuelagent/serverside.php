...
if (isset($_POST['search']['value'])) {
    ...
    $sql .= " WHERE fuelAgentName like '%" . $search_value . "%'";
    $sql .= " OR fuelAgentPhoneNumber like '%" . $search_value . "%'";
    $sql .= " OR fuelAgentNIN like '%" . $search_value . "%'";
    $sql .= " OR fuelStationName like '%" . $search_value . "%'";
}

$sql .= datatables_order_clause($_POST['order'] ?? null, ['fuelAgentName', 'fuelAgentNIN', 'fuelAgentPhoneNumber', 'anotherPhoneNumber', 'fuelStationName', 'status'], 'fuelAgentId DESC');
