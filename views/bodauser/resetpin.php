...
if (isset($_POST["reset"])) {
    ...
    $sms->sendsms(
        ...
        "Hello " . $allbodaUser[0]["bodaUserName"] . " Your Pin has  been reset successfully on CreditPlus Dail *217*212# to get started Remember your one time pin is " . $oneTymPin
    );
