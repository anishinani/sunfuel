...
$sql .= datatables_order_clause($_POST['order'] ?? null, ['bodaUserId', 'bodaUserName', 'bodaUserNIN', 'bodaUserBodaNumber', 'bodaUserRole', 'bodaUserPhoneNumber', 'alternativePhotoNumber', 'fuelStationName', 'stageName'], 'bodaUserId ASC');
