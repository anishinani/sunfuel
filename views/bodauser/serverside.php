...
while ($row = mysqli_fetch_assoc($query)) {
    ...
    $sub_array[] = '<a href="javascript:void();" data-id="' . $row['bodaUserId'] . '" 
     class="btn btn-info btn-sm editbtn" >Edit</a>  <a href="javascript:void();" data-id="' . $row['bodaUserId'] . '" 
