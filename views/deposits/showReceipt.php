...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        if (isset($_GET['showReceipt'])) {
            ...
            //die($depositId);
            //SELECT fuelstation.* ,deposits.* FROM fuelstation INNER JOIN deposits ON fuelstation.fuelStationId = deposits.fuelStationId

            $depositDetails =   $dbAccess->selectQuery("SELECT fuelstation.* ,deposits.* FROM fuelstation INNER JOIN deposits ON fuelstation.fuelStationId = deposits.fuelStationId 
            WHERE deposits.fuelStationId = $depositId");
            //$dbAccess->select("fuelagent", "", ["fuelAgentId" => $AgentId]);
            //var_dump($depositDetails);
            //die("here");
        } else {
            //die("not sent");
        }
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Fuel Station Deposits </h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Fuel Station Deposits</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
