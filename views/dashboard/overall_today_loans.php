...
breadCrumbs(['title' => 'All Today loans', 'sub_title' => 'details', 'previous' => 'Dashboard', 'previous_action' => '../dashboard/']);
...
try {
    //code...
    $sql = "SELECT bodauser.bodaUserName , bodauser.bodaUserPhoneNumber, bodauser.stageId, loan.loanAmount , loan.loanInterest, loan.created_at, loan.updated_at , loan.status , loan.loan_penalty FROM bodauser INNER JOIN loan ON bodauser.bodaUserPhoneNumber = loan.boadUserId WHERE DATE(loan.created_at) = CURDATE()";
