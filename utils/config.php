...
$auth_conf['site_name'] = "Sunfuel"; // Name of website to appear in emails
$auth_conf['email_from'] = "no-reply@auth.sunfuel.ug"; // Email FROM address for Auth emails (Activation, password reset...)
$auth_conf['max_attempts'] = 5; // INT : Max number of attempts for login before user is locked out
$auth_conf['base_url'] = "http://app.sunfuel.ug/"; // URL to Auth Class installation root WITH trailing slash
