<?php
/**
 * Import Subcounties Data Final
 * This script will import subcounties from the clean data file
 */

require_once 'utils/dbaccess.php';

echo "Import Subcounties Data Final\n";
echo "============================\n";
...
try {
    ...
    // Read the clean values file
    $valuesFile = '/Applications/XAMPP/xamppfiles/htdocs/sunfuel/subcounties_clean.sql';
